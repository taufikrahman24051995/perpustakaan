...
$kategori = query("SELECT * FROM kategori WHERE kode_kategori = '$kode_kategori'")[0];
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" >
              ...
              <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="kategori.php" class="active"><i class="fa fa-list-alt fa-fw"></i> Data Kategori</a>
                            </li>
                            <li>
             ...
             <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-list-alt fa-fw"></i> Ubah Data Kategori</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                     <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Kode Kategori" name="kode_kategori" id="kode_kategori" value="<?php echo $kategori["kode_kategori"]; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="nama_kategori">Nama</label>
                        <input class="form-control" placeholder="Nama Kategori" name="nama_kategori" id="nama_kategori" value="<?php echo $kategori["nama_kategori"]; ?>" autofocus autocomplete="off" required>
                    </div>
                    <button type="submit" class="btn btn-success" name="ubah_kategori">Ubah Kategori</button>
                    </form>
                </div>
        </div>
        <!-- /#wrapper -->
